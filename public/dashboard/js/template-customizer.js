...
TemplateCustomizer.LANGUAGES = {
  ...
  ar: {
    panel_header: 'الإعدادات',
    panel_sub_header: 'التخصيص والمعاينة في الوقت الحقيقي',
    theming_header: 'الموضوع',
    theme_header: 'السمة',
    theme_label: 'السمات',
    style_label: 'النمط (الوضع)',
    style_switch_light: 'نهاري',
    style_switch_dark: 'ليلي',
    layout_header: 'التخصطيط',
    layout_label: 'تخطيط (القائمة)',
    layout_static: 'ثابتة',
    layout_offcanvas: 'متحركة',
    layout_fixed: 'متحركة',
    layout_fixed_offcanvas: 'Fixed offcanvas',
    layout_flipped_label: 'Menu flipped',
    layout_dd_open_label: 'القائمة المنسدلة عند التمرير',
    layout_navbar_label: 'تحريك اعلى الصفحة',
    layout_footer_label: 'تحريك اسفل الصفحة',
    misc_header: 'MISC',
