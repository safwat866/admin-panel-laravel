        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="formAjax needs-validation" action="{{ route("roles.store") }}" method="post"
                            novalidate>
                            @csrf
                            <div class="">
                                <div class="col-md-6 p-2 col-12">
                                    <label for="input-name">الاسم</label>
                                    <input type="text" class="form-control" required="" name="name" id="input-name" value="" placeholder=" اكتب الاسم">
                                </div>
                                ...
                                <div class="col-12 d-flex justify-content-center mt-3">
                                    <button type="submit" class="btn rounded-pill btn-primary  m-2 submit-button waves-effect waves-light">إضافة</button>
