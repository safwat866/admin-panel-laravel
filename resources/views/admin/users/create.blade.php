        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('routes.admin.users.add') }}</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                    <form class="formAjax form-horizontal needs-validation" novalidate action="{{ route("users.store") }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 ">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" value="{{ old("email") }}" class="form-control @error('email') !border-red-600 @enderror" required
                                ...
                                <div class="mb-3 col">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" value="{{ old(key: "number") }}" class="form-control @error('number') !border-red-600 @enderror" required
